(() => {
  ...
  function reduceRaceYears(races) {
  ...
  // src/graph/constructorColors.js
  var colorsMain = {
    1: "#FF8700",
    3: "#FFFFFF",
    4: "#FFF500",
  ...
  function renderGraph(race, constructors, ...drivers) {
    ...
    const innerHeight = 580 - margin.top - margin.bottom;
  ...
  // src/dropdown/populateSelectElement.js
  function populateSelectElement(element, data, value, id2, textCb, sortCb = (a, b) => a - b) {
  ...
  // src/changeThemeButton/changeThemeButton.js
  function changeThemeButton() {
    ...
    function changeColor(cssVar, color2) {
      document.documentElement.style.setProperty(cssVar, color2);
    }
    button.addEventListener("click", () => {
      if (defaultTheme) {
        changeColor("--main-bg-color", "linear-gradient(0, #241d58eb 86%,#fb6bbb 90%)");
  ...
  var changeThemeButton_default = changeThemeButton;

  // entry.js
  document.addEventListener("DOMContentLoaded", async () => {
    changeThemeButton_default();
    const selection2 = {
      raceId: "1052",
      year: "2021",
      driver1Id: "1",
    ...
    document.querySelector(".dropdowns").addEventListener("change", (e) => {
      if (e.target.classList.contains("dropdown")) {
        switch (e.target.name) {
          case "year-select":
            selection2.year = e.target.value;
            break;
          case "race-select":
          ...
          case "driver1-select":
            ...
            break;
          case "driver2-select":
            selection2.driver2Id = e.target.value;
            break;
        }
